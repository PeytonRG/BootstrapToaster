// import { Toast, TOAST_STATUS } from "../../dist/esm/bootstrap-toaster.js";
...
timeoutInput.onchange = () => {
  ...
  else toast.message = "New toasts must be manually dismissed.";
...
infoBtn.onclick = () => {
  let toast = {
    title: "Greetings!",
    message:
      'I am <a href="https://www.halopedia.org/2401_Penitent_Tangent" class="link-danger" target="_blank"' +
...
queueBtns.forEach((btn) => {
  btn.onclick = () => {
    ...
    let toast = {
      ...
      message: `The toast queue has been ${
